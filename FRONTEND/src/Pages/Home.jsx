    ...
    return (
        <div className="min-h-screen bg-black text-white">
            <section className="min-h-screen bg-[#F5F1EB]">
                <div className="max-w-full  mx-auto pl-24 py-12 flex flex-col lg:flex-row items-center justify-between">
                    ...
                    <div className="ml-16  lg:mt-0">
                        <img  className='h-112 ' src="../../public/ChatGPT.png" alt="Image "/>
                    </div>
                </div>
            </section>
        </div>
